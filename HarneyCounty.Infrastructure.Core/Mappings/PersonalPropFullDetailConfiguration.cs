...
namespace HarneyCounty.Infrastructure.Core.Mappings
{
    ...
    public class PersonalPropFullDetailConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<PersonalPropFullDetail>
    {
        public PersonalPropFullDetailConfiguration()
            : this("dbo")
        {
        }

        public PersonalPropFullDetailConfiguration(string schema)
        {
