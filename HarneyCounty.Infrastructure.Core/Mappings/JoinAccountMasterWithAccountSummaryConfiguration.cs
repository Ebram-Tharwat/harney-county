...
namespace HarneyCounty.Infrastructure.Core.Mappings
{
    ...
    public class JoinAccountMasterWithAccountSummaryConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<JoinAccountMasterWithAccountSummary>
    {
        public JoinAccountMasterWithAccountSummaryConfiguration()
            : this("dbo")
        {
        }

        public JoinAccountMasterWithAccountSummaryConfiguration(string schema)
        {
            ...
            Property(x => x.Expr2).IsOptional().HasPrecision(4,0);
            Property(x => x.Expr3).IsOptional().IsFixedLength().IsUnicode(false);
