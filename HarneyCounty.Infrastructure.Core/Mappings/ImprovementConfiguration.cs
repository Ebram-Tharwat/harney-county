...
namespace HarneyCounty.Infrastructure.Core.Mappings
{
    ...
    public class ImprovementConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Improvement>
    {
        public ImprovementConfiguration()
            : this("dbo")
        {
        }

        public ImprovementConfiguration(string schema)
        {
