...
{
    // see: https://www.itworld.com/article/2956575/development/how-to-sort-search-and-paginate-tables-in-asp-net-mvc-5.html
    public static class HtmlHelpers
    {
        ...
        public static IHtmlString SortIdentifier(this HtmlHelper htmlHelper, string sortOrder, string field)
        {
            ...
            string glyph = "glyphicon glyphicon-arrow-up";
