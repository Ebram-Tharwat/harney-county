...
using HarneyCounty.Web.App_Start;
using HarneyCounty.Web.ViewModel;
using HarneyCounty.Web.ViewModel.Admin;
...
namespace HarneyCounty.Web.Controllers
{
    ...
    public class UserAdminController : Controller
    {
        ...
        public async Task<ActionResult> Edit([Bind(Include = "Email,Id,FullName,PhoneNumber, UserName,LockedOut,RolesList")] EditUserViewModel editUser, params string[] selectedRole)
        {
            if (ModelState.IsValid)
            {
